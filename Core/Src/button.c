...
void button_led_toggle_test(void)
{
	...
	if (get_button(GPIOC, GPIO_PIN_6, BTN0 ) == BUTTON_PRESS)
	{
		HAL_GPIO_TogglePin(GPIOB, GPIO_PIN_0);
	}
	if (get_button(GPIOC, GPIO_PIN_7, BTN1 ) == BUTTON_PRESS)
	{
		HAL_GPIO_TogglePin(GPIOB, GPIO_PIN_1);
	}
	if (get_button(GPIOC, GPIO_PIN_8, BTN2 ) == BUTTON_PRESS)
	{
		HAL_GPIO_TogglePin(GPIOB, GPIO_PIN_2);
	}
	if (get_button(GPIOC, GPIO_PIN_9, BTN3 ) == BUTTON_PRESS)
	{
